...
export function createPilotReviewGetHandler(dependencies: PilotReviewGetDependencies) {
  return async function pilotReviewGet(req: NextRequest) {
    ...
    return NextResponse.json(await dependencies.getReview(studentId, dependencies.now()));
  };
}
